// Table de curation manuelle isolée de scrutinRepository.ts pour ne pas
// noyer sa logique (~200 lignes) sous cette table de données qui, elle,
// continue de grossir au fil des audits (cf. #33/#34/#42) — un module par
// responsabilité plutôt qu'un fichier de 1000+ lignes mêlant les deux.
...
export const DOSSIER_REF_OVERRIDE: Record<string, string> = {
